...
Regime affects risk, never trade direction.
"""
import pandas as pd
import logging
...
def classify_regime(df: pd.DataFrame) -> dict:
    if df.empty or len(df) < 50:
        return {"regime": MarketRegime.RANGING, "confidence": 0, "atr_pct": 0, "note": "Insufficient data"}
    ...
    try:
        ...
        return {"regime": MarketRegime.RANGING, "confidence": 0, "atr_pct": 0, "note": str(e)}
